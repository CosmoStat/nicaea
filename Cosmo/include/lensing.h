...
#define lensing_spherical               -15 + lensing_base
...
typedef enum {limber, limber_la08, limber_la08_hyb, limber_la08_sph, limber2_la08, limber2_la08_hyb,
	      limber2_la08_sph, full} projection_t;
#define sprojection_t(i) ( \
 i==limber           ? "limber" : \
 i==limber_la08      ? "limber_la08" : \
 i==limber_la08_hyb  ? "limber_la08_hyb" : \
 i==limber_la08_sph  ? "limber_la08_sph" : \
 i==limber2_la08     ? "limber2_la08" : \
 i==limber2_la08_hyb ? "limber2_la08_hyb" : \
 i==limber2_la08_sph ? "limber2_la08_sph" : \
 i==full             ? "full" : \
 "")
#define Nprojection_t 8
...
typedef struct {
  ...
  /* 2nd-order Limber approximation, power-law parameters for fit to filter function */
  double *w2_c0, *w2_c1;
...
cosmo_lens *init_parameters_lens(double OMEGAM, double OMEGAV, double W0_DE, double W1_DE,
				 ...
				 norm_t normmode, tomo_t TOMO, projection_t PROJECTION, reduced_t REDUCED,
				double Q_MAG_SIZE, ia_t IA, ia_terms_t ia_terms, double A_IA, error **err);
